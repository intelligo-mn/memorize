...
public class Word {
    ...
    public Word(String id, String character, String meaning, String meaningMon, String kanji, String partOfSpeech, String level, String isMemorize, String isFavorite, String created) {
        this.id = id;
